...
private:
    ...
    static KeyboardState m_prevState;
    static BYTE m_currState[256];

    static inline bool IsKeyPressed(BYTE value) { return (value & 0x80) > 0; };
};
